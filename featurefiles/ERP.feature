...
As admin user i want to test supplier and customer modules
  ...
  Scenario Outline: add supplier
    ...
    Examples:
      ...
      | Doll Corp1 | Street 12 | New York | USA     | Akheles61 | 1234567890 | doll@test.com | 9876543310 | High  |
  ...
  Scenario Outline: add  customer
    ...
    Examples:
      ...
      | Alibe W1 | Lane 55 | London | UK      | Alice   | 1122334455 | alice@test.com | 5544332222 | Retail |
      | Alice W3 | Lane 57 | London | UK      | Alice   | 1122334455 | aloce@test.com | 5544332211 | Retail |
